...
def run():
  ...
  message_response = jacobs_proto.test_message(jacobs_grpc_pb2.message_request(message=f'{fake.name()}', requester = 'jacob'))
  print(f"Client received from sender {message_response.sender} -- {message_response.message}")
